...
* __The Gender Gap in Carbon Footprint__, with Ondine Berland (Draft available upon request)
    ...
    <summary> Abstract: </summary>
    <br>
    <p align="justify"> Understanding the distribution of carbon emissions across population groups is central for
designing fair and acceptable climate policies. We uncover a significant gender gap in carbon footprints using individual-level data from France on food consumption and transport use, two categories representing half of individuals’ emissions, matched with detailed product-level emission intensities. Women’s footprints are 26% lower than men’s. This gap exists both among couples and singles, and narrows only to 18% when controlling for socio-economic characteristics. Women’s lower emissions are not only explained by their lower calorie requirements or shorter distances travelled, but also by the lower emission intensity of their
consumption. Emissions from red meat and cars make up a disproportionate share of the gender gap after conditioning on socio-economic factors and the scale of consumption, highlighting the potential role of consumption preferences tied to gender identity. The magnitude of the gap implies that gender would warrant more consideration in the literature as a relevant dimension of climate inequality and as a potential determinant and consequence of other climate-related gender gaps
    </p>
    </details>
