...
* __Building Bike Lanes, Changing Commutes?__, with Léa Bou-Sleiman (NUS) and Corentin Trévien (INSEE)
   <details>
    <summary> Abstract: </summary>
    <br>
    <p align="justify"> Many European cities have expanded cycling infrastructure (cycling lanes and tracks) over the past decade to encourage a shift away from polluting transport modes toward cycling. To what extent does cycling infrastructure affect commuting modes? We study this question in the context of Paris, where cycling infrastructure density has increased by 60% since 2017 and bike commuting has nearly doubled. We exploit restricted-access census survey data with geocoded commuting flows. In a reduced-form exercise, we compare mode choices of individuals exposed to an increase in cycling infrastructure in their neighbourhood of residence or along their commute itineraries, relative to those unexposed or less exposed. A 10% increase in cycling infrastructure coverage near home increases the propensity to commute by bike by 2% in the first year of exposure, and on average by  0.7% per year of exposure. Exposure along the entire commute itinerary also increases cycling. The effect is not driven by changes in neighbourhood composition. Preliminary work suggests that new bike commutes primarily displace commutes by motorcycle and public transport. 
     </p>
    </details>
